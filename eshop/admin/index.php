    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?template=catalog&table=core_goods&title=Товары">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?template=catalog&table=core_sections&title=Секции">
...
<?php if ($_GET['template'] == 'catalog') { ?>
      <h2><?=$_GET['title']?></h2>
      <a class="btn btn-primary" href="?template=card&table=<?=$table?>" role="button">Создать+</a>
